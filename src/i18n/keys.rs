...
text_keys! {
    ...
    SETTINGS_TAB_GAME => SettingsTabGame,
    SETTINGS_TAB_DISPLAY => SettingsTabDisplay,
    SETTINGS_TAB_VOICE => SettingsTabVoice,
    SETTINGS_TAB_APP => SettingsTabApp,
    SETTINGS_ROUTE_LINE_WIDTH => SettingsRouteLineWidth,
    ...
    SETTINGS_RESET_GAME => SettingsResetGame,
}
