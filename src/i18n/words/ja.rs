...
impl JapaneseWords {
    ...
    pub const TITLE: &'static str = "タイトル";
    ...
    pub const INFORMATION: &'static str = "情報";

    // 状態・形容詞
    pub const ALIVE: &'static str = "生存";
    pub const DEAD: &'static str = "死亡";
    pub const CURRENT: &'static str = "現在";
